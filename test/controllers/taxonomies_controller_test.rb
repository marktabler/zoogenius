...
class TaxonomiesControllerTest < ActionController::TestCase
  ...
  test "should create taxonomy" do
    assert_difference('Taxonomy.count') do
      post :create, taxonomy: { family: @taxonomy.family, genus: @taxonomy.genus, order: @taxonomy.order, phylum: @taxonomy.phylum, tclass: @taxonomy.tclass }
    end
  ...
  test "should update taxonomy" do
    patch :update, id: @taxonomy, taxonomy: { family: @taxonomy.family, genus: @taxonomy.genus, order: @taxonomy.order, phylum: @taxonomy.phylum, tclass: @taxonomy.tclass }
    assert_redirected_to taxonomy_path(assigns(:taxonomy))
  end
